...
## Overview
The **Student CGPA Calculator** is a Python-based console application designed to assist students in calculating their Cumulative Grade Point Average (CGPA). [cite_start]By inputting individual grades and their corresponding credit weights, the system computes the weighted average to provide an accurate academic performance metric[cite: 90].

## Features
* [cite_start]**Weighted Calculation:** accurately calculates CGPA by multiplying grades by their respective credits and dividing by total credits[cite: 92].
...
* [cite_start]**Language:** Python 3.x [cite: 93]
* **Libraries:** Standard Python I/O (No external dependencies required).
...
To verify the application is working correctly, follow these steps[cite: 95]:
...
GGPA CALCULATOR
---------------------------------------------------------
Enter the number of grades and credits: 2
---------------------------------------------------------
Enter the grade mark: 9
Enter the credit for the above grade: 3
Enter the grade mark: 8
Enter the credit for the above grade: 4
----------------------------------------------------------
Grade:  [9.0, 8.0]
Credits:  [3, 4]
Total Credits:  7
The CGPA is:  8.428571428571429
-----------------------------------------------------------
